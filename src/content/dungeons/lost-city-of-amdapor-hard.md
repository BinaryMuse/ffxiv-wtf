...
Return to the ruins of Amdapor to face new threats lurking within the overgrown city.

## Achamoth

| Mechanic | Type | Description |
|----------|------|-------------|
| Psycho Squama | **Cleave** | Large frontal cone AoE at a random player - move out when boss turns toward you |
| Enthrallment | **AoE** | Room-wide damage |
| Neuro Squama | **AoE** | Circle AoEs on random players |
...
| Mechanic | Type | Description |
|----------|------|-------------|
| Ancient Aero | **AoE** | Wind-based AoE attacks |
| Ancient Holy | **Raidwide** | Heavy party-wide damage |
