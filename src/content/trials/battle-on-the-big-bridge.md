...
A comedic 8-player trial from the Hildibrand Adventures questline. Face the legendary Gilgamesh in this entertaining but mechanically interesting encounter.
...
| Bomb | - | At ~40% HP, signals start of Phase 2 |

### Phase 2 (Add Phase)

| Mechanic | Type | Description |
|----------|------|-------------|
| Crossing Bateleurs | **Adds** | Add wave - tank and burn with AoE |
| Crossing Hippocerfs | **Adds** | Add wave - tank and burn with AoE |

After adds die, Gilgamesh returns using Phase 1 abilities. **Debuffs can now apply to multiple players simultaneously.**
